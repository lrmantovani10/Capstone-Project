    ...
    useEffect(() => {
        try {
                ...
                if (userToken.length > 0) {
                    ...
                    axios.get(`${
                        props.process.env.REACT_APP_APIURL
                    }/get_user`, headers).then((response) => {
                    ...
                    <div id="profileImageHeader">
                        ...
                        <div className="imageAlign">
                            ...
                            <div className="attributeSelection" id="editProfileImage">
                                <input id="profilePicChange" type="file" accept=".png, .jpeg, .jpg"
                                    onChange={
                                        (event) => props.handleChangeImage(event, "profilePicPreview")
                                    }/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="editProfileParameters">
                        <div className="parameterGrid">
                            <div className="attributeSelection">
                                ...
                                <input id="emailChange" className="textInput" type="email" maxLength="50"
                                    defaultValue={
                            ...
                            <div className="attributeSelection">
                                ...
                                <input id="passwordChange" className="textInput" type="password" maxLength="50"
                                    defaultValue={
                                        props.currentUser.password
                                    }/>
                            </div>
                            ...
                            props.currentUser.type == 0 ? (
                                <div className="attributeSelection">
                                    ...
                                    <input id="ageChange" className="textInput" type="number" min="18" max="110"
                                        defaultValue={
                            ...
                            <div className="attributeSelection">
                                ...
                                <input id="sectorChange" className="textInput" type="text" maxLength="50"
                                    defaultValue={
                            ...
                            props.currentUser.type == 0 ? (
                                <div className="attributeSelection">
                                    ...
                                    <input id="occupationChange" className="textInput" type="text" maxLength="50"
                                        defaultValue={
                            ...
                            <div className="attributeSelection">
                                ...
                                <input id="experienceChange" className="textInput" type="number" min="0" max="40"
                                    defaultValue={
                            ...
                            <div className="attributeSelection">
                                ...
                                <input id="websiteChange" className="textInput" type="url" maxLength="50"
                                    defaultValue={
                                        props.currentUser.other_link
                                    }/>
                            </div>

                            <div className="attributeSelection">
                                <div className="abelFont">LinkedIn URL</div>
                                <input id="linkedinChange" className="textInput" type="url" maxLength="50"
                                    defaultValue={
                        ...
                        <div id="resumeActions">
                            ...
                            props.currentUser.type == 0 ? (
                                <div className="attributeSelection" id="resumeAlign">
                                    ...
                                    <input id="resumeChange" type="file" accept=".docx, .txt, .pdf, .doc"/>
                                </div>
                            ) : (
                                <></>
                            )
                        ...
                        [...Array(6).keys()].map((index) => {
                            return (
                                <div key={
                                    ...
                                    <img key={
                                            "additionalChangeImage" + index
                                        }
                                        id={
                                            "editPicture" + index
                                        }
                                        src={
                                            props.extraImages[index]
                                        }
                                    ...
                                    <div key={
                                        ...
                                        <input id={
                                            ...
                                            accept=".png, .jpeg, .jpg"
                                            onChange={
                                                (event) => props.handleChangeImage(event, "editPicture" + index)
                                            }/>
                                    </div>
                                </div>
                            );
                    ...
                    <div id="interestFlex">
                        <div className="interestGrid">
                            ...
                            ["sectors", "positions", "locations"].map((element, index) => {
                                const firstUppercase = element.charAt(0).toUpperCase() + element.slice(1);
                                const baseInterest = props.currentUser;
                                const parameterArray = [baseInterest.interested_sectors, baseInterest.interested_positions, baseInterest.interested_locations,];
                                return (
                                    <div key={
                                        "interestWrapper" + index
                                    }>
                                    ...
                                    <div className="attributeSelection"
                                        ...
                                        <div id="buttonSelection">
                                            ...
                                            <span>
                                                <AddIcon onClick={
                                                        () => {
                                                            props.handleAdd("new" + firstUppercase, "interested_" + element);
                                                        }
                                                    }
                                                    className="addIcon"
                                                    sx={
