            ...
            <div className="swipingGeneral">
                    ...
                    <div className="swipingBasic">
                        ...
                        <div className="aboutMe">
                            ...
                            <div id="profileSector">
                                {
                                props.profile.sector.length > 0 ? (props.currentUser.type == 1 ? (props.profile.occupation + " in the " + props.profile.sector + " sector") : (props.profile.sector + " sector")) : (
                                    <></>
                                )
                            }
                                {
                                props.profile.distance ? ("  " + props.profile.distance.toFixed(0) + " miles away") : (
                                    <></>
                                )
                            }
                                {" "} </div>
                            ...
                            props.extraImages.map((picture, index) => {
                                return (
                                    <img alt={
                                        ...
                                        src={
                                            picture.length > 0 ? picture : process.env.REACT_APP_OTHERS + "default.png"
                                    }></img>
                                );
                            })
                        }
                ...
                <div className="buttonChoice">
                    <ThemeProvider theme={
                        ...
                        <Button onClick={
                                () => props.handleSwipe(0, props.currentUser.email)
                            }
                            variant="outlined"
                            style={
                                {
                        ...
                        <Button onClick={
                                () => props.handleSwipe(1, props.currentUser.email)
                            }
                            variant="contained"
                            style={
                                {
