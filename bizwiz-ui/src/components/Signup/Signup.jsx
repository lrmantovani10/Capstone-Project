                                ...
                                <div className="card-body p-md-5">
                                    <div className="row justify-content-center">
                                        <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1" id="multipleItems">
                                            <p id="signupMessage" className="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">
                                                Sign up
                                            </p>
                                            ...
                                            <form className="mx-1 mx-md-4">
                                                ...
                                                <div className="d-flex flex-row align-items-center mb-4">
                                                    ...
                                                    <div className="form-outline flex-fill mb-0">
                                                        ...
                                                        <label className="form-label" htmlFor="repeatPasswordInput">
                                                            Repeat your password
                                                        </label>
                                                    </div>
                                                </div>

                                                <p id="accountDescriptor">Account Type</p>
                                                <div className="accountTypeSelector">
                                                    <input className="accountTypes form-check-input me-1" type="checkbox" value="" id="check1"
                                                        onClick={
                                                            () => handleCheck("check1")
                                                        }/>
                                                    ...
                                                    <input className="accountTypes form-check-input me-2" type="checkbox" value="" id="check2"
                                                        onClick={
                                                            () => handleCheck("check2")
                                                        }/>
                                                ...
                                                <p id="loginOption">
                                                    Already have a Bizwiz or a Facebook account?
