                    ...
                    >
                      ...
                      <form className="mx-1 mx-md-4">
                        ...
                        <div className="accountTypeSelector">
                          <input
                            className="accountTypes form-check-input me-1"
                            type="checkbox"
                            value=""
                            id="check1"
                            onClick={() => {
                              props.SignupFunctions.handleCheck("check1");
                            }}
                          />
                          ...
                          <input
                            className="accountTypes form-check-input me-2"
                            type="checkbox"
                            value=""
                            id="check2"
                            onClick={() => {
                              props.SignupFunctions.handleCheck("check2");
                            }}
                          />
