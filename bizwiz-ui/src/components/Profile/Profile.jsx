        ...
        return (
            <div className="profilePage">
                <div className="profileHeader">
                    ...
                    <h1 className="abelFont whiteAbel">
                        {
                    ...
                    <div className="swipingBasic">
                        <img id="profileImage"
                            src={
                                props.profileImage.length > 0 ? props.profileImage : process.env.REACT_APP_PROFILES + "default.png"
                            }/>
                        <div className="secondItem">
                            <div>
                                ...
                                <p className="myIntro" id="generalInfo">
                                    {
                                    props.currentUser.sector.length > 0 ? (props.currentUser.type == 0 ? (props.currentUser.occupation + " in the " + props.currentUser.sector + " sector  with " + props.currentUser.interested_years + " years of experience") : ("In the " + props.currentUser.sector + " sector looking for hires with " + props.currentUser.interested_years + "+ years of experience")) : (
                                        <></>
                                    )
                                }
                                    {" "} </p>
                            ...
                            <div id="currentInfo" className="abelFont whiteAbel">
                                ...
                                <div id="currentLinks">
                                    ...
                                    props.currentUser.other_link.length > 0 ? (
                                        ...
                                        <a className="personalLink"
                                            onClick={
                                                () => alert("Edit your profile to add a personal website link!")
                                        }>
                                            Website
                                        </a>
                                    )
                        ...
                        <div className="swipingBasic">
                            <div className="interestsDiv">
                                ...
                                <div className="currentInterests">
                                    {
                                    props.currentUser.interested_sectors.map((element, index) => {
                                        return (
                                            <p className="interestElement"
                                                key={
                                                    "sector" + index
                                            }>
                                                {element}
                            ...
                            <div className="interestsDiv">
                                ...
                                <div className="currentInterests">
                                    {
                                    props.currentUser.interested_positions.map((element, index) => {
                                        return (
                                            <p className="interestElement"
                                                key={
                                                    "position" + index
                            ...
                            <div className="interestsDiv">
                                ...
                                <div className="currentInterests">
                                    {
                                    props.currentUser.interested_locations.map((element, index) => {
                                        return (
                                            <p className="interestElement"
                                                key={
                                                    "location" + index
