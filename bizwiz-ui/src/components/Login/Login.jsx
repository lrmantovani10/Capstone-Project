                ...
                <div className="card-body p-md-5">
                  <div className="row justify-content-center">
                    <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1" id = "multipleItems">
                      ...
                      <p id="loginMessage" className="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Log In</p>
                      ...
                      <form className="mx-1 mx-md-4">
                        ...
                        <div className="d-flex flex-row align-items-center mb-4">
                          ...
                          <div className="form-outline flex-fill mb-0">
                            <input type="email" id="loginInput" className="form-control" />
                            <label className="form-label" htmlFor="loginInput">Email</label>
                          </div>
                        </div>
                        ...
                        <div className="d-flex flex-row align-items-center mb-4">
                          ...
                          <div className="form-outline flex-fill mb-0">
                            <input type="password" id="passInput" className="form-control" />
                        ...
                        <p id = "signupOption">Don't have an account? <a href = "/signup">Sign up!</a></p>
